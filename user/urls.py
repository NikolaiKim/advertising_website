...
from user.views import AccessTokenView, CustomTokenRefreshView, ActivateUserEmail
...
urlpatterns = [
    ...
    path('auth/users/activate/<str:uid>/<str:token>/', ActivateUserEmail.as_view(), name='user-activate'),
